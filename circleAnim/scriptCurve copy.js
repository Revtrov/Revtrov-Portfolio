...
let reset = (objs) => {
    ...
    for (let i = 0; i < objs.length; i++) {
        ...
        objs[i].objColor = `rgba(${/*newR*/255}, 0, 255)`;
...
let colArray = [];
let colRingArray = [];
colors = ["rgb(255, 0, 255)", "rgb(255, 0, 255)"]
...
for (let i = 0; i < objCount; i++) {
    objects.push(new Object( /*sizes[getRandomInt(0, sizes.length)]*/ getRandomInt(1, 3), 2, 0, 0, 0, 0, colors[colArray[i]], getRandomInt(0, 2)))
}
